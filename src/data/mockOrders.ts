...
export const mockOrders: Order[] = [
  {
    ...
    customer: {
      ...
      phone: "6001459296",
      address: {
        line1: "Mahindra and Mahindra financial services LtdK B road, Domino's Building 3rd floor, Near Dos & Co Pin-785001",
        city: "JORHAT",
        state: "ASSAM",
        pincode: "785001",
        country: "IN",
...
export const customerOrdersMap = new Map<string, Order[]>([
  ...
  ["1234567890", [mockOrders[5], mockOrders[6], mockOrders[0], mockOrders[3]]], // For testing with existing login
]);
